---
name: execute-spec
description: "Execute a structured spec.md file: loads constraints, creates task list from Decomposition, works through sub-tasks with guardrails and escalation triggers, logs progress to execution-log.md.
"
---
