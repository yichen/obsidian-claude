...
description: A guide for drafting and reviewing technical documentation with a focus on narrative impact, quantitative evidence, and clear structure. Auto-triggers when writing analysis documents, MVP definitions, spec reviews, proposals, or any multi-section stakeholder-facing document.
trigger:
  - When writing or rewriting any document that will be read by stakeholders (investors, lawyers, partners, team members)
  - When the output is a standalone .md file with 3+ sections (not inline chat responses)
  - Specific document types that MUST use this skill: MVP definitions, spec reviews, market analyses, competitive landscapes, technical proposals, panel reports, compliance analyses, cost-benefit analyses, launch plans, post-mortems
  - When the user asks to "write up", "document", "draft", "create a report", or "summarize findings into a document"
  - When any agent (Composer, Researcher, Architect) is producing a final deliverable document
---
...
**IMPORTANT**: This skill is a STYLE GUIDE, not a workflow. Apply these standards to whatever document you are producing. Every standalone analysis or proposal document written to the vault MUST follow these rules.
...
*   **Descriptive Headers:** Use headers that convey the *insight*, not just the topic.
    ...
    *   *Bad:* "Compliance Stack"
    *   *Good:* "A $4-7K Compliance Stack That Launches in All 50 States"
    *   *Bad:* "Pricing"
    *   *Good:* "One Parent Pays $7/mo — 83% Cheaper Than OFW per Family"
...
*   **Differentiation:** Clearly distinguish between verified data and estimates.
    *   Use **bold** for verified/sourced numbers
    *   Use *italics* or "~" prefix for estimates (e.g., "~$5K estimated")
